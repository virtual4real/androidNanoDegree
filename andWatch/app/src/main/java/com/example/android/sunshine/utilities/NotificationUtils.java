...
public class NotificationUtils {
    ...
    /**
     * Sends to watch the newly updated weather for today.
     *
     * @param context Context used to query our ContentProvider and use various Utility methods
     */
    public static void notifyWearOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            dataMap.putString(HIGH_TEMP, Double.toString(high));
            dataMap.putString(LOW_TEMP, Double.toString(low));
                    ...
                    .setResultCallback(new ResultCallback<NodeApi.GetConnectedNodesResult>() {
                        ...
                        public void onResult(@NonNull NodeApi.GetConnectedNodesResult connectedNodes) {
                            for(Node connectedNode : connectedNodes.getNodes()) {
                                Log.d(TAG,"Message Sender connected node"+connectedNode.getDisplayName());
                                sendMessage("Hello Hello 2", mGoogleApiClient, connectedNode);
                            }
                        }
                    });*/
    ...
    private static void sendMessage(final String message, final GoogleApiClient mGoogleApiClient, Node mNode) {
